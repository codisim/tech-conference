...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PORCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "products_sku_categoryId_isActice_idx" ON "products"("sku", "categoryId", "isActice");

-- CreateIndex
CREATE UNIQUE INDEX "categories_slug_key" ON "categories"("slug");

-- CreateIndex
CREATE INDEX "categories_slug_isActice_idx" ON "categories"("slug", "isActice");
...
-- CreateIndex
CREATE INDEX "orders_userId_orderNumber_status_idx" ON "orders"("userId", "orderNumber", "status");
...
-- CreateIndex
CREATE INDEX "payments_orderId_userId_transactionId_idx" ON "payments"("orderId", "userId", "transactionId");

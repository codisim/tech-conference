...
export class CreateOrganizerDto {
  ...
  @ApiProperty({ description: "Company name of the organizer", example: "Tech Events Ltd" })
  @IsString()
  @IsNotEmpty({ message: "Company name cannot be empty." })
  companyName: string;

  @ApiProperty({ description: "Contact information", example: "contact@techevents.com" })
  @IsString()
